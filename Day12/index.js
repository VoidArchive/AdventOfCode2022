...
const getHikingTrailLength = (grid, start) => {
    const queue = [[start, 0]];
    const visited = new Set();
    while (queue.length) {
        const [current, stepCount] = queue.shift();
